...
'Note: TransparentBlt requires Win NT/2k/XP
...
'raster operations to use with BitBlt/StretchBlt
'use them where dwRop parameter appears
'(Use vbSrcCopy etc. instead!)
